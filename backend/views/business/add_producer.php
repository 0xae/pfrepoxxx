...
<div class="add-producer-form" style="border-bottom:1px solid #ccc; padding: 10px;background-color:#fff ">
...
<div class="row">
    ...
    <div class="col-md-3">
        <br/>
        <?php echo Html::submitButton('Adicionar', ['class' =>  'btn btn-success', 'id'=> 'submit_producer']); ?>
    </div>
</div> <!-- .row -->
<?php ActiveForm::end(); ?>
...
<div class="producer-listing" style="clear: both; padding: 15px;background-color:#f5f5f5;">
<div class="row">
