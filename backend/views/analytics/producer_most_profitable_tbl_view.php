...
<table class="table table-striped fb-stats">
    <thead>
        <tr class="active fb-table-header">
            ...
            <th class="fb-header" style="text-align: center">Business Revenue</th>
            <th class="fb-header" style="text-align: center">Passafree Revenue</th>
        </tr>
    </thead>
    <tbody>
        <tr ng-repeat="p in topSellers">
            ...
            <td class="fb-col">
                <center>
                    <strong>
                        <span class="money"> {{ p.passafree_revenue }} </span>  
                    </strong>
                </center>
            </td>
